...
{
    public $title = 'Faktur Penjualan Header';
    ...
    public function index(Request $request)
    {
        ...
        return view('fakturpenjualanheader.index', compact('title'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        return view('reports.fakturpenjualanpdf', compact('header', 'details'));
    }
