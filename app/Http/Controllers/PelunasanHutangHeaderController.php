...
{
    public $title = 'Pelunasan Hutang Header';
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'jenispelunasanhutangmemo' => $this->combo('list', 'JENIS PELUNASAN', 'JENIS PELUNASAN'),
        ];
        return view('pelunasanhutangheader.index', compact('title', 'data'));
    }
