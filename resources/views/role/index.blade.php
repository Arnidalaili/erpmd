        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary card-outline card-outline-tabs">
                    ...
                    <div class="card-body" style="min-height: 780px">
        ...
        <script>
                                  ...
                                  if (xhr.status === 200) {
                                    if (response !== undefined) {
                                      var blob = new Blob([response], {
                                        type: 'role/vnd.ms-excel'
                                      });
                                      var link = document.createElement('a');
                                      link.href = window.URL.createObjectURL(blob);
                                      link.download = 'role' + new Date().getTime() + '.xlsx';
                                      link.click();
                                    }
          ...
          $('#processingLoader').addClass('d-none')
                ...
                $("#tabs").on('click', 'li.ui-state-active', function() {
                    ...
                    $(`#tabs #${currentTab}-tab`).html('').load(`${appUrl}/role/${currentTab}/grid`,
                function() {
