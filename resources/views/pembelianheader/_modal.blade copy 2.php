        ...
        $('#btnSubmit').click(function(event) {
            ...
            $('#crudForm tbody tr.filled-row').each((index, element) => {
                ...
                details[rowIndex] = {
                    ...
                    qtyretur: AutoNumeric.getNumber($(form).find(`[name="qtyretur[]"]`)[rowIndex]),
                    qtystok: AutoNumeric.getNumber($(form).find(`[name="stok[]"]`)[rowIndex]),
                    qtypesanan: AutoNumeric.getNumber($(form).find(`[name="qtypesanan[]"]`)[rowIndex]),
                ...
                success: response => {
                    ...
                    if (detectDeviceType() == "desktop") {
                        ...
                        $.each(response.detail, (index, detail) => {
                            selectIndex = index;
                            let detailRow = $(`
                                <tr  class="filled-row" id="valueId_${detail.id}">
                                    <td class="table-bold">
                                    </td>
                                    <td class="table-bold">
