<?php
    if (isset($id)) { ?>
<table id="groupCustomerLookup<?= $id ?>" class="lookup-grid"></table>
<?php
    } else { ?>
<table id="groupCustomerLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#groupCustomerLookup{{ isset($id) ? $id : null }} `)
    ...
    selector.jqGrid({
            url: `{!! $url ?? config('app.api_url') . 'groupcustomer' !!}`,
            mtype: "GET",
            styleUI: 'Bootstrap4',
            iconSet: 'fontAwesome',
            datatype: "json",
            ...
            loadComplete: function(data) {
                ...
                if (data.data.length === 0) {
                    ...
                    $('#groupCustomerGrid').each((index, element) => {
