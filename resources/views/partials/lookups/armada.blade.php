<?php
    if (isset($id)) { ?>
<table id="armadaLookup<?= $id ?>" class="lookup-grid"></table>
<?php
    } else { ?>
<table id="armadaLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#armadaLookup{{ isset($id) ? $id : null }} `)
