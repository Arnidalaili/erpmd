<?php
    if (isset($id)) { ?>
<table id="groupProductLookup<?= $id ?>" class="lookup-grid"></table>
<?php
    } else { ?>
<table id="groupProductLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#groupProductLookup{{ isset($id) ? $id : null }} `)
    ...
    selector.jqGrid({
            url: `{!! $url ?? config('app.api_url') . 'groupproduct' !!}`,
            mtype: "GET",
            styleUI: 'Bootstrap4',
            iconSet: 'fontAwesome',
            datatype: "json",
            ...
            loadComplete: function(data) {
                ...
                if (data.data.length === 0) {
                    ...
                    $('#groupProductGrid').each((index, element) => {
