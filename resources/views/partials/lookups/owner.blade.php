<?php
    if (isset($id)) { ?>
<table id="ownerLookup<?= $id ?>" class="lookup-grid"></table>
<?php
    } else { ?>
<table id="ownerLookup" class="lookup-grid"></table>
<?php } ?>
...
<script>
    ...
    selector = $(`#ownerLookup{{ isset($id) ? $id : null }} `)
