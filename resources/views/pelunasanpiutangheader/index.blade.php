...
<div class="container-fluid">
    ...
    @include('pelunasanpiutangheader._details')
        ...
        $(document).ready(function() {
            ...
            $("#jqGrid").jqGrid({
                    ...
                    colModel: [{
                        ...
                        },
                        {
                            ...
                            name: 'jenispelunasanpiutangmemo',
                            width: 100,
                            stype: 'select',
                            searchoptions: {
                                value: `<?php
                                        $i = 1;
                                        foreach ($data['jenispelunasanpiutangmemo'] as $status) :
                                            echo "$status[param]:$status[parameter]";
                                            if ($i !== count($data['jenispelunasanpiutangmemo'])) {
                                                echo ';';
                                            }
                                            $i++;
                                        endforeach;
            ...
            `,
                            ...
                            formatter: (value, options, rowData) => {
                                let jenispelunasanpiutangmemo = JSON.parse(value)

                                let formattedValue = $(`
                <div class="badge" style="background-color: ${jenispelunasanpiutangmemo.WARNA}; color: #fff;">
                  <span>${jenispelunasanpiutangmemo.SINGKATAN}</span>
                </div>
              `)
                            ...
                            cellattr: (rowId, value, rowObject) => {
                                ...
                                let jenispelunasanpiutangmemo = JSON.parse(rowObject.jenispelunasanpiutangmemo)

                                return ` title="${jenispelunasanpiutangmemo.MEMO}"`
                            }
                        },
                        {
                            label: 'Alat Bayar',
                ...
                .customPager({
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            onClick: () => {
                                selectedId = $("#jqGrid").jqGrid('getGridParam', 'selrow')
                                viewPelunasanPiutangHeader(selectedId)
                            }
                        }
                    ]
                })
            ...
            function permission() {
                ...
                if (!`{{ $myAuth->hasPermission('pelunasanpiutangheader', 'show') }}`) {
