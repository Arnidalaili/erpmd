                ...
                colModel: [{
                    ...
                    },
                    {
                        ...
                        searchoptions: {
                            value: `<?php
                                    $i = 1;
                                    foreach ($data['tipebankmemo'] as $status) :
                                        echo "$status[param]:$status[parameter]";
                                        if ($i !== count($data['tipebankmemo'])) {
                                            echo ';';
                                        }
                                        $i++;
                                    endforeach;
                        ...
                        formatter: (value, options, rowData) => {
                            let tipeBank = JSON.parse(value)
                            if (!tipeBank) {
                                return ''
                            }
                            let formattedValue = $(`
                                        <div class="badge" style="background-color: ${tipeBank.WARNA}; color: #fff;">
                                        <span>${tipeBank.SINGKATAN}</span>
                                        </div>
                                    `)
                        ...
                        cellattr: (rowId, value, rowObject) => {
                            let tipeBank = JSON.parse(rowObject.tipebank)
                            if (!tipeBank) {
                                return ` title=""`
                            }
                            return ` title="${tipeBank.MEMO}"`
                        }
                    },
                    {
                        label: 'KETERANGAN',
