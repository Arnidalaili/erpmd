...
@section('content')
    ...
    @include('transaksiarmada._modaleditalltransaksiarmada')
    @include('transaksiarmada._modal')
    @push('scripts')
        <script>
            let indexRow = 0;
            let page = 0;
            ...
            `,
              ...
              `)
                                ...
                                <div class="card-body">
                                    <div id="footer-grid">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <strong><p><span id="total-panjar" class="autonumeric-nozero"></span></p>
                            ...
                            },
                            {
                                ...
                                onClick: function(event) {
                                    ...
                                    if (selectedId == null || selectedId == '' || selectedId == undefined) {
                                        ...
                                        editTransaksiArmada(selectedId)
                                    }
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                onClick: () => {
                                    ...
                                    if (selectedId == null || selectedId == '' || selectedId == undefined) {
                                        ...
                                        deleteTransaksiArmada(selectedId)
                                    }
                                }
                            },
                            {
                                ...
                                onClick: () => {
                                    selectedId = $("#jqGrid").jqGrid('getGridParam', 'selrow')
                                    viewTransaksiArmada(selectedId)
                                }
                            },
                            {
                                id: 'report',
                ...
                function permission() {
                    ...
                    if (!`{{ $myAuth->hasPermission('transaksiarmada', 'store') }}`) {
                        $('#add').attr('disabled', 'disabled')
                    }

                    if (!`{{ $myAuth->hasPermission('transaksiarmada', 'show') }}`) {
                        $('#view').attr('disabled', 'disabled')
                    }

                    if (!`{{ $myAuth->hasPermission('transaksiarmada', 'update') }}`) {
                        $('#edit').attr('disabled', 'disabled')
                    }

                    if (!`{{ $myAuth->hasPermission('transaksiarmada', 'destroy') }}`) {
