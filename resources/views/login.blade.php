...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <img class="mx-auto d-block" src="{{ asset('libraries/tas-lib/img/logo-ds.png') }}" width="150"
                height="150">
            {{-- <h5 style="font-family: 'Open Sans Condensed';">PT. TRANSPORINDO AGUNG SEJAHTERA</h5> --}}
             <p style="font-family: 'Open Sans Condensed'; font-size:1.2rem" class="text-success">DEDI SEGAR</p>
        </div>
        <div class="card">
                ...
                <form action="{{ route('login.process') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="user" id="user"
                            class="form-control @error('user') is-invalid @enderror" placeholder="User ID" autocomplete="off" autofocus>
