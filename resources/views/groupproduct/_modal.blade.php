...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.btn-batal', function(event) {
      ...
      if ($('#crudForm').data('action') == 'edit') {
        ...
        $.ajax({
          url: `{{ config('app.api_url') }}groupproduct/editingat`,
          method: 'POST',
          dataType: 'JSON',
          headers: {
    ...
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let groupProductId = form.find('[name=id]').val()
      ...
      switch (action) {
        ...
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}groupproduct/${groupProductId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}groupproduct/${groupProductId}`
  ...
  function createGroupProduct() {
    ...
    $('#crudModalTitle').text('Create Group Product')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function editGroupProduct(groupProductId) {
    let form = $('#crudForm')
    ...
    $('#crudModalTitle').text('Edit Group Product')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
    ...
    Promise
      .all([
        setStatusOptions(form),
        editingAt(groupProductId, 'EDIT'),
        getMaxLength(form)
      ])
      .then(() => {
        showGroupProduct(form, groupProductId)
          .then(() => {
            $('#crudModal').modal('show')
          })
          .catch((error) => {
  ...
  function deleteGroupProduct(groupProductId) {
    let form = $('#crudForm')
    ...
    `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Group Product')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function getMaxLength(form) {
      ...
      return new Promise((resolve, reject) => {
          $.ajax({
          url: `${apiUrl}groupproduct/field_length`,
          method: 'GET',
          dataType: 'JSON',
          headers: {
              'Authorization': `Bearer ${accessToken}`
  ...
  function showGroupProduct(form, groupProductId) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}groupproduct/${groupProductId}`,
        method: 'GET',
  ...
  function showDefault(form) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}groupproduct/default`,
        method: 'GET',
        dataType: 'JSON',
        headers: {
          Authorization: `Bearer ${accessToken}`
