...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.btn-batal', function(event) {
      ...
      if ($('#crudForm').data('action') == 'edit') {
        ...
        $.ajax({
          url: `{{ config('app.api_url') }}groupcustomer/editingat`,
          method: 'POST',
          dataType: 'JSON',
          headers: {
    ...
    $('#btnSubmit').click(function(event) {
      ...
      let url
      let form = $('#crudForm')
      let groupCustomerId = form.find('[name=id]').val()
      ...
      switch (action) {
        ...
        case 'edit':
          method = 'PATCH'
          url = `${apiUrl}groupcustomer/${groupCustomerId}`
          break;
        case 'delete':
          method = 'DELETE'
          url = `${apiUrl}groupcustomer/${groupCustomerId}`
  ...
  function createGroupCustomer() {
    ...
    $('#crudModalTitle').text('Create Group Customer')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function editGroupCustomer(groupCustomerId) {
    let form = $('#crudForm')
    ...
    $('#crudModalTitle').text('Edit Group Customer')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
    ...
    Promise
      .all([
        setStatusOptions(form),
        editingAt(groupCustomerId, 'EDIT'),
        getMaxLength(form)
      ])
      .then(() => {
        showGroupCustomer(form, groupCustomerId)
          .then(() => {
            $('#crudModal').modal('show')
          })
          .catch((error) => {
  ...
  function deleteGroupCustomer(groupCustomerId) {
    let form = $('#crudForm')
    ...
    `)
    form.find(`.sometimes`).hide()
    $('#crudModalTitle').text('Delete Group Customer')
    $('.is-invalid').removeClass('is-invalid')
    $('.invalid-feedback').remove()
  ...
  function getMaxLength(form) {
        ...
        return new Promise((resolve, reject) => {
            $.ajax({
            url: `${apiUrl}groupcustomer/field_length`,
            method: 'GET',
            dataType: 'JSON',
            headers: {
                'Authorization': `Bearer ${accessToken}`
  ...
  function showGroupCustomer(form, groupCustomerId) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}groupcustomer/${groupCustomerId}`,
        method: 'GET',
  ...
  function showDefault(form) {
    return new Promise((resolve, reject) => {
      $.ajax({
        url: `${apiUrl}groupcustomer/default`,
        method: 'GET',
        dataType: 'JSON',
        headers: {
          Authorization: `Bearer ${accessToken}`
