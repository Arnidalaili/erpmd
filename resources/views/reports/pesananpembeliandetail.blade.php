...
<head>
 ...
 <script type="text/javascript">
    ...
    let pesananpembeliandetail = <?= json_encode($pesananpembeliandetail); ?>

    function Start() {
        console.log(pesananpembeliandetail)
      ...
      report.loadFile(`{{ asset('public/reports/ReportPesananPembelianDetail.mrt') }}`)

      report.dictionary.dataSources.clear()
      

      dataSet.readJson({
        'pesananpembeliandetail': <?= json_encode($pesananpembeliandetail); ?>,
      })
