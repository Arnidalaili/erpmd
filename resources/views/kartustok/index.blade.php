...
<script>
    ...
    $(document).ready(function() {
                ...
                colModel: [{
                    ...
                    },
                    {
                        ...
                        formatter: function (cellvalue, options, rowObject) {
                            var formattedValue = currencyFormatStok(cellvalue,true);
                    ...
                    },
                    {
                        label: 'Qty Saldo',
                        name: 'qtysaldo',
                        formatter: currencyFormatStok,
                        align: 'right'
                    },
                    {
                        label: 'Total Saldo',
                        name: 'totalsaldo',
                        formatter: currencyFormatNoDoubleZeroStok,
                        align: 'right'
                    },
                    {
                        label: 'Supplier/Customer',
                        name: 'customer_suppliernama',
                        align: 'left'
                    },
                    {
                        label: 'Status',
        ...
        $('#jqgh_jqGrid_qtypenerimaan').css("color", 'blue')
        $('#jqgh_jqGrid_qtypengeluaran').css("color", 'red')
        $('#jqgh_jqGrid_totalpenerimaan').css("color", 'blue')
        $('#jqgh_jqGrid_totalpengeluaran').css("color", 'red')
