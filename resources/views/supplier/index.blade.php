...
<script>
    ...
    $(document).ready(function() {
                ...
                colModel: [{
                    ...
                    },
                    {
                        ...
                        cellattr: (rowId, value, rowObject) => {
                               ...
                               let status = JSON.parse(rowObject.top)
        ...
        function permission() {
            ...
            if (!`{{ $myAuth->hasPermission('supplier', 'import') }}`) {
        ...
        $('#btnImport').click(function(event) {
            ...
            let url = `${apiUrl}supplier/import`
